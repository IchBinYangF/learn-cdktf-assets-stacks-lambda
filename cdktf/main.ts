...
class LambdaStack extends TerraformStack {
  constructor(scope: Construct, name: string, config: LambdaFunctionConfig) {
    ...
    new aws.provider.AwsProvider(this, "aws", {
      region: "eu-central-1",
      // accessKey: "ASIAZ6QXH42LBEH7QD4W",
      // secretKey: "dv6PqkUpolWDyaciJlX7Oe2M9+3JrAG+ea6loyzl",
      sharedConfigFiles:["/Users/yangfu/.aws/config"],
      sharedCredentialsFile:"/Users/yangfu/.aws/credentials",
      profile:"Yang1"
    });
